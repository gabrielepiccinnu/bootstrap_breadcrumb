...
function bootstrap_breadcrumb() {
    ...
    if ( (is_front_page()) || (is_home()) ) {
        $html .= '<li itemprop="itemListElement" itemscope itemtype="' . $schema_link . '" class="breadcrumb-item active" aria-current="page"><span itemprop="name">' . __('Home', 'wordflex') .  '</span><meta itemprop="position" content="' . $position++ .'" /></li>';
    }

    else {
        $html .= '<li itemprop="itemListElement" itemscope itemtype="' . $schema_link . '" class="breadcrumb-item"><a href="' . esc_url(home_url('/')) . '" itemprop="item"><span itemprop="name">' . __('Home', 'wordflex') . '</span></a><meta itemprop="position" content="' . $position++ .'" /></li>';
        ...
        if (get_page_by_path('blog')) {
            if (!is_page()) {
                $html .= '<li itemprop="itemListElement" itemscope itemtype="' . $schema_link . '" class="breadcrumb-item"><a href="' . get_permalink(get_page_by_path('blog')) . '" itemprop="item">' . $sep . '<span itemprop="name">' . __('Blog', 'wordflex') . '</span></a><meta itemprop="position" content="' . $position++ .'" /></li>';
            }
        }
